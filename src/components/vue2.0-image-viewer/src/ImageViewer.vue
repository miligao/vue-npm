    ...
    <transition name="imageViewer">
      <div class="imageViewerMask" v-if="visible">
        <div class="imageViewerLayer" ref="imageViewerLayer">
          <transition :name="listName">
            ...
            >
              <div
                class="loading"
                v-if="
                  imagesInfo[currentIndex] && !imagesInfo[currentIndex].onload
                "
              ></div>
              <img
                v-if="
          ...
          <div class="zoomPercent" v-show="!isFullScreen && showZoomPercent">
            {{ Math.ceil(zoom * 100) + "%" }}
          </div>
          <div class="pointBar">
            ...
            <slot name="handleBar">
              <div class="handleBar">
                <div
                  class="button"
                  @click="zoomAuto"
                  :title="zoomType === 'natural' ? '适应窗口' : '实际尺寸'"
                >
                  <img
                ...
                <div class="button" @click="zoomIn">
                  <img src="./assets/zoom_in.png" alt="放大" />
                </div>
                <div class="button" @click="zoomOut">
                  <img src="./assets/zoom_out.png" alt="缩小" />
                </div>
                ...
                <div class="button" @click="leftRotate">
                  <img src="./assets/left_rotate.png" alt="左旋" />
                </div>
                <div class="button" @click="rightRotate">
                  <img src="./assets/right_rotate.png" alt="右旋" />
                </div>
  ...
  methods: {
    ...
    zoomAuto() {
      if (this.zoomType === "natural") {
        ...
        let { offsetWidth: viewW, offsetHeight: viewH } =
    ...
    mousemove(e) {
      if (this.isFullScreen) return;
      let maxW = this.$refs.imageContainer
